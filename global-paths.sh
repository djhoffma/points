...
FILES_LIST="$MEMBERS_LIST $SCORE_FILE $SETUP_SCRIPT $GLOBAL_VARS $GENERATE_MEMBERS_SCRIPT $DISPLAY_SCORES_SCRIPT $GET_SCORE_SCRIPT $GIVE_PTS_SCRIPT $GIVE_PRIZES_SCRIPT"
BASE_SCORE="10"
